export function TestnetSetup() {
  return <details className="testnet-setup">
    ...
    <p>USDC has been tested end to end. HBAR settlement verification is pending; video meetings are experimental. Availability can change—an enabled service is not a guarantee of a successful call or lookup.</p>
