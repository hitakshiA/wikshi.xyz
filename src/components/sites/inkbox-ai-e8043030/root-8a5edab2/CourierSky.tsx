...
const routes=[
 ...
 // Continue past the scene instead of starting/ending in open sky.
 'M -160 30 C -20 35 30 110 100 180 C 400 460 390 110 690 285 S 1100 580 1350 120 C 1390 45 1490 -30 1600 -80',
];
...
export function CourierSky(){
 ...
 <g stroke="#d3dfbe" strokeWidth="1" strokeOpacity=".2" strokeLinecap="round">{routes.map(path=><path key={path} d={path} strokeDasharray="3 9"/>)}</g>
